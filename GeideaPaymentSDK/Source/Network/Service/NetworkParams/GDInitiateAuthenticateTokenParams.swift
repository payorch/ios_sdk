//
//  GDInitiateAuthenticateTokenParams.swift
//  GeideaPaymentSDK
//
...
struct InitiateAuthenticateTokenParams: Codable {
...
//    var paymentMethod: PaymentMethodParams = PaymentMethodParams()
    ...
    init(amount: GDAmount, tokenId: String?, tokenizationDetails: GDTokenizationDetails?, paymentIntentId: String? = nil, customerDetails: GDCustomerDetails?, orderId:String? = nil, paymentMethods: [String]? = nil) {
