//
//  JSONSerialiation+Extensions.swift
//  GeideaPaymentSDK
//
...
extension JSONSerialization {
    ...
    open class func decimalData(withJSONObject obj: Any, options opt: JSONSerialization.WritingOptions = [.fragmentsAllowed]) throws -> Data {
        return try data(withJSONObject: decimalObject(obj), options: opt)
    }

    /// Write Double values as Decimal values.
    open class func writeDecimalJSONObject(_ obj: Any, to stream: OutputStream, options opt: JSONSerialization.WritingOptions = [.prettyPrinted], error: NSErrorPointer) -> Int {
